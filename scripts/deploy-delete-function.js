...
async function deploy() {
  ...
  try {
    ...
    const functionDir = join(__dirname, '../functions/delete_state');
    ...
    if (!envContent.includes('VITE_APPWRITE_DELETE_FUNCTION_ID')) {
        envContent += `\nVITE_APPWRITE_DELETE_FUNCTION_ID="${functionId}"\n`;
